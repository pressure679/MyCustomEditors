...
(add-to-list 'load-path "~/.emacs.d/elpa/evil-escape-20150910.2131")
...
(add-to-list 'custom-theme-load-path "~/.emacs.d/elpa/themes/zenburn-theme-20150831.716")
(add-to-list 'custom-theme-load-path "~/.emacs.d/elpa/themes/cyberpunk-theme-20150828.508")
(add-to-list 'custom-theme-load-path "~/.emacs.d/elpa/themes/monokai-theme-20150521.2257")
(add-to-list 'custom-theme-load-path "~/.emacs.d/elpa/themes/monochrome-theme-20140326.350")
(add-to-list 'custom-theme-load-path "~/.emacs.d/elpa/themes/gruvbox-theme-20150729.341")
(add-to-list 'custom-theme-load-path "~/.emacs.d/elpa/themes/solarized-theme-20150916.504")
(add-to-list 'custom-theme-load-path "~/.emacs.d/elpa/themes/occidental-theme-2013312.1257")
