...
sudo tar -C /usr/share -xzf go1.5.4.linux-amd64.tar.gz
...
go get github.com/mkaz/working-with-go
cd $GOPATH/src/github.com/sjwhitworth/golearn
go get ./...

cd ~/Documents
wget https://astaxie.gitbooks.io/build-web-application-with-golang/content/en/preface.html --page-requisites --recursive --level 1
wget http://cse.unl.edu/~sscott/ShowFiles/SQL/CheatSheet/SQLCheatSheet.html --page-requisites
wget http://www.w3schools.com/sql/sql_quickref.asp --page-requisites
