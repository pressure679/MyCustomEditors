...
sudo apt-get install emacs git mercurial irssi build-essential make cmake automake w3m python-dev linux-firmware gccgo-4.9 ctags tor tlp google-chrome-stable indicator-cpufreq cpufrequtils psensor lm-sensors vlc audacious picard spotify-client htop openssh-server fluxgui
