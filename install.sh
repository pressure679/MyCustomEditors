...
sudo apt-get install vim emacs24 git mercurial irssi build-essential make cmake automake w3m python-dev linux-firmware gccgo-4.9 ctags thinkfan tor tlp thinkfan google-chrome-stable indicator-cpufreq
cd $HOME
mkdir $HOME/.vim
chmod $USER $HOME/.vim
